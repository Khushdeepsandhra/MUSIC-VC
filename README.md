...
[![Deploy on Heroku](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/khushdeepsandhra/Music-VC)
...
```bash
$ git clone https://github.com/khushdeepsandhra/Music-VC
$ cd MusicPlayer
$ cp sample.env .env
